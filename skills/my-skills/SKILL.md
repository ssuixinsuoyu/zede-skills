---
name: my-skills
description: "Route requests to the correct Skill in this collection: skill-selector for choosing among installed Skills, content-topic-ideator for batch self-media topic discovery and account analysis, zede-video-copywriter for writing a complete spoken video script from a topic after confirming the core viewpoint, zede-plan-learning-roadmap for evidence-based learning plans and progress replanning, interactive-learning for adaptive tutoring, and interactive-explainer for click-through 16:9 HTML explainers. Use when the user invokes $my-skills or gives a request that clearly belongs to one of these workflows."
---
...
| User intent | Route |
| --- | --- |
| Decide which installed Skill best fits a request, compare several Skills, or resolve an unclear first route | `$skill-selector` |
...
- "我不知道这个任务该用哪个 Skill" -> `$skill-selector`
