...
该命令会安装 6 个功能 Skill 和 1 个总入口 Skill。
...
| Skill | 用途 |
| --- | --- |
| `my-skills` | 总入口。判断请求属于 Skill 选择、选题、视频文案、学习还是视觉讲解，并路由到对应子 Skill。 |
| `skill-selector` | 动态比较已安装 Skill，信息不足时先询问，选出最合适的入口并在输出前完成核验。 |
...
$skill-selector 我不知道这个任务该使用哪个 Skill，请帮我判断并调用。
